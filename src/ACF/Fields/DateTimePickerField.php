...
class DateTimePickerField extends Field
{
    ...
    /**
     * The date format that is displayed when selecting a date. Default 'd/m/Y g:i a'.
     * 
     * @var string
     */
    public $display_format = 'd/m/Y g:i a';

    /**
     * The date format that is returned when loading the value. Default 'd/m/Y g:i a'.
     * Please note that the value is always saved as Ymd (YYYYMMDD) in the database.
     * 
     * @var string
     */
    public $return_format = 'd/m/Y g:i a';
